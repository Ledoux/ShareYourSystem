...
},{"./Coder/src":8}],2:[function(require,module,exports){
/*!
...
window.addEventListener("load", function() {
  var CodeMirror, base64, cjsxScript, editorTextArea, jsScript, resultFrame, run, runButton, scriptCodeMirror, scriptObject;
  ...
  run = function() {
    ...
    return resultFrame.src = "data:text/html;charset=utf-8;base64," + sourceStr;
  };
  run();
