...
<h1 id="interfacer">Interfacer</h1>
<h2 id="doc">Doc</h2>
<hr>
<blockquote>
<p>The Interfacer</p>
...
<hr>
<p><small>
View the Interfacer notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Interfacer.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<p><small>
View the Interfacer sources on <a href="https://github.com/Ledoux/ShareYourSystem/tree/master/ShareYourSystem/Interfacers/Interfacer">Github</a>
</small></p>
</div>
</div>
</div></section><section>
...
<span class="kn">from</span> <span class="nn">ShareYourSystem.Interfacers</span> <span class="kn">import</span> <span class="n">Interfacer</span>

<span class="c">#Definition </span>
<span class="n">MyInterfacer</span><span class="o">=</span><span class="n">Interfacer</span><span class="o">.</span><span class="n">InterfacerClass</span><span class="p">()</span>
...
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;MyInterfacer is &#39;</span><span class="o">+</span><span class="n">SYS</span><span class="o">.</span><span class="n">_str</span><span class="p">(</span>
            <span class="n">MyInterfacer</span><span class="p">,</span>
...
<h1 id="folderer">Folderer</h1>
<h2 id="doc">Doc</h2>
<hr>
<blockquote>
<p>The Folderer is a quick object helping for getting the FolderedDirKeyStrsList
at a specified directory or in the current one by default</p>
</blockquote>
<hr>
<p><small>
View the Folderer notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Folderer.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<p><small>
View the Folderer sources on <a href="https://github.com/Ledoux/ShareYourSystem/tree/master/ShareYourSystem/Interfacers/Folderer">Github</a>
</small></p>
</div>
</div>
</div></section><section>
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Interfacers</span> <span class="kn">import</span> <span class="n">Folderer</span>

<span class="c">#Definition of an instance Folderer and make it find the current dir</span>
<span class="n">MyFolderer</span><span class="o">=</span><span class="n">Folderer</span><span class="o">.</span><span class="n">FoldererClass</span><span class="p">(</span>
    <span class="p">)</span><span class="o">.</span><span class="n">folder</span><span class="p">(</span>
        <span class="n">Folderer</span><span class="o">.</span><span class="n">LocalFolderPathStr</span>
    <span class="p">)</span>

<span class="c">#If you don&#39;t have these folder, MyFolderer is going to create them for you</span>
<span class="n">MyFolderer</span><span class="o">=</span><span class="n">Folderer</span><span class="o">.</span><span class="n">FoldererClass</span><span class="p">(</span>
    <span class="p">)</span><span class="o">.</span><span class="n">folder</span><span class="p">(</span>
        <span class="n">MyFolderer</span><span class="o">.</span><span class="n">FolderingPathStr</span><span class="o">+</span><span class="s">&#39;TestFolder1/TestFolder2/&#39;</span><span class="p">,</span>
...
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;MyFolderer is &#39;</span><span class="o">+</span><span class="n">SYS</span><span class="o">.</span><span class="n">_str</span><span class="p">(</span><span class="n">MyFolderer</span><span class="p">,</span>
...
<h1 id="filer">Filer</h1>
<h2 id="doc">Doc</h2>
<hr>
<blockquote>
<p>The Filer is a quick object for opening a FiledFileVariable and safely using (read,write) 
it depending on the FiledModeStr.</p>
</blockquote>
<hr>
<p><small>
View the Filer notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Filer.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<p><small>
View the Filer sources on <a href="https://github.com/Ledoux/ShareYourSystem/tree/master/ShareYourSystem/Interfacers/Filer">Github</a>
</small></p>
</div>
</div>
</div></section><section>
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Interfacers</span> <span class="kn">import</span> <span class="n">Filer</span>

<span class="c">#Definition of an instance Filer and make it find the current dir</span>
<span class="n">MyFiler</span><span class="o">=</span><span class="n">Filer</span><span class="o">.</span><span class="n">FilerClass</span><span class="p">()</span><span class="o">.</span><span class="n">file</span><span class="p">(</span><span class="s">&#39;MyFile.txt&#39;</span><span class="p">,</span><span class="s">&#39;w&#39;</span><span class="p">,</span>
    <span class="o">**</span><span class="p">{</span>
    <span class="s">&#39;FolderingPathStr&#39;</span><span class="p">:</span>
    <span class="n">Filer</span><span class="o">.</span><span class="n">LocalFolderPathStr</span>
    <span class="p">}</span>
<span class="p">)</span>

<span class="c">#close</span>
<span class="n">MyFiler</span><span class="o">.</span><span class="n">FiledFileVariable</span><span class="o">.</span><span class="n">close</span><span class="p">()</span>

<span class="c">#Definition the AttestedStr</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;MyFiler is &#39;</span><span class="o">+</span><span class="n">SYS</span><span class="o">.</span><span class="n">_str</span><span class="p">(</span><span class="n">MyFiler</span><span class="p">,</span>
        <span class="o">**</span><span class="p">{</span><span class="s">&#39;RepresentingAlineaIsBool&#39;</span><span class="p">:</span><span class="bp">False</span><span class="p">})</span>
    <span class="p">]</span>
<span class="p">)</span> 
...
<hr>
<p><small>
View the Closer notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Closer.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<p><small>
View the Closer sources on <a href="https://github.com/Ledoux/ShareYourSystem/tree/master/ShareYourSystem/Interfacers/Closer">Github</a>
</small></p>
</div>
</div>
</div></section><section>
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Interfacers</span> <span class="kn">import</span> <span class="n">Closer</span>

<span class="c">#Definition of an instance Closer and make it find the current dir</span>
<span class="n">MyCloser</span><span class="o">=</span><span class="n">Closer</span><span class="o">.</span><span class="n">CloserClass</span><span class="p">()</span><span class="o">.</span><span class="n">file</span><span class="p">(</span><span class="s">&#39;MyFile.txt&#39;</span><span class="p">,</span><span class="s">&#39;w&#39;</span><span class="p">)</span><span class="o">.</span><span class="n">close</span><span class="p">()</span>

<span class="c">#Definition the AttestedStr</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;MyCloser is &#39;</span><span class="o">+</span><span class="n">SYS</span><span class="o">.</span><span class="n">_str</span><span class="p">(</span>
            <span class="n">MyCloser</span><span class="p">,</span>
            <span class="o">**</span><span class="p">{</span>
                <span class="s">&#39;RepresentingAlineaIsBool&#39;</span><span class="p">:</span><span class="bp">False</span>
            <span class="p">}</span>
        <span class="p">)</span>
...
<hr>
<blockquote>
<p>The Loader is a quick object to load from a FiledFileVariable a LoadedReadVariable</p>
</blockquote>
<hr>
<p><small>
View the Loader notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Loader.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Interfacers</span> <span class="kn">import</span> <span class="n">Loader</span>

<span class="c">#Definition of an instance Loader and make it find the current dir</span>
<span class="n">MyLoader</span><span class="o">=</span><span class="n">Loader</span><span class="o">.</span><span class="n">LoaderClass</span><span class="p">()</span><span class="o">.</span><span class="n">file</span><span class="p">(</span><span class="s">&#39;MyFile.txt&#39;</span><span class="p">,</span><span class="s">&#39;w&#39;</span><span class="p">)</span>
<span class="n">MyLoader</span><span class="o">.</span><span class="n">FiledFileVariable</span><span class="o">.</span><span class="n">write</span><span class="p">(</span><span class="s">&#39;hello&#39;</span><span class="p">)</span>
<span class="n">MyLoader</span><span class="o">.</span><span class="n">FiledFileVariable</span><span class="o">.</span><span class="n">close</span><span class="p">()</span>
<span class="n">MyLoader</span><span class="o">.</span><span class="n">load</span><span class="p">()</span>

<span class="c">#Definition the AttestedStr</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;MyLoader is &#39;</span><span class="o">+</span><span class="n">SYS</span><span class="o">.</span><span class="n">_str</span><span class="p">(</span><span class="n">MyLoader</span><span class="p">,</span>
            <span class="o">**</span><span class="p">{</span><span class="s">&#39;RepresentingAlineaIsBool&#39;</span><span class="p">:</span><span class="bp">False</span><span class="p">}</span>
        <span class="p">)</span>
    <span class="p">]</span>
<span class="p">)</span> 
...
<hr>
<blockquote>
<p>The Writer is a quick object to write from a LoadedReadVariable.</p>
</blockquote>
<hr>
<p><small>
View the Writer notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Writer.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<p><small>
View the Writer sources on <a href="https://github.com/Ledoux/ShareYourSystem/tree/master/ShareYourSystem/Interfacers/Writer">Github</a>
</small></p>
</div>
</div>
</div></section><section>
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Interfacers</span> <span class="kn">import</span> <span class="n">Writer</span>

<span class="c">#Definition of an instance Writer and make it find the current dir</span>
<span class="n">MyWriter</span><span class="o">=</span><span class="n">Writer</span><span class="o">.</span><span class="n">WriterClass</span><span class="p">()</span><span class="o">.</span><span class="n">write</span><span class="p">(</span><span class="s">&quot;hello&quot;</span><span class="p">,</span><span class="o">**</span><span class="p">{</span>
    <span class="s">&#39;FolderingPathStr&#39;</span><span class="p">:</span><span class="n">Writer</span><span class="o">.</span><span class="n">LocalFolderPathStr</span><span class="p">,</span>
    <span class="s">&#39;FilingKeyStr&#39;</span><span class="p">:</span><span class="s">&#39;MyFile.txt&#39;</span><span class="p">,</span>
    <span class="s">&#39;FilingModeStr&#39;</span><span class="p">:</span><span class="s">&#39;w&#39;</span>
    <span class="p">}</span>
<span class="p">)</span>
...
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;MyWriter is &#39;</span><span class="o">+</span><span class="n">SYS</span><span class="o">.</span><span class="n">_str</span><span class="p">(</span><span class="n">MyWriter</span><span class="p">)</span>
    <span class="p">]</span>
<span class="p">)</span> 
...
<hr>
<p><small>
View the Deployer notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Deployer.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<p><small>
View the Deployer sources on <a href="https://github.com/Ledoux/ShareYourSystem/tree/master/ShareYourSystem/Interfacers/Deployer">Github</a>
</small></p>
</div>
</div>
</div></section><section>
...
<span class="kn">from</span> <span class="nn">ShareYourSystem.Interfacers</span> <span class="kn">import</span> <span class="n">Folderer</span><span class="p">,</span><span class="n">Deployer</span>

<span class="c">#Definition a Deployer</span>
<span class="n">MyDeployer</span><span class="o">=</span><span class="n">Deployer</span><span class="o">.</span><span class="n">DeployerClass</span><span class="p">()</span><span class="o">.</span><span class="n">deploy</span><span class="p">()</span>

<span class="c">#Definition the AttestedStr</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;MyDeployer is &#39;</span><span class="o">+</span><span class="n">SYS</span><span class="o">.</span><span class="n">_str</span><span class="p">(</span>
        <span class="n">MyDeployer</span><span class="p">,</span>
        <span class="o">**</span><span class="p">{</span>
...
<h1 id="hdformater">Hdformater</h1>
<h2 id="doc">Doc</h2>
<hr>
<blockquote>
<p>An Hdformater instance maps an apply and so &quot;grinds&quot; a MappingArgDictsList 
to a method.</p>
</blockquote>
<hr>
<p><small>
View the Hdformater notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Hdformater.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<p><small>
View the Hdformater sources on <a href="https://github.com/Ledoux/ShareYourSystem/tree/master/ShareYourSystem/Interfacers/Hdformater">Github</a>
</small></p>
</div>
</div>
</div></section><section>
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Interfacers</span> <span class="kn">import</span> <span class="n">Hdformater</span>

<span class="c">#Definition a Hdformater that writes an empty hdf file</span>
...
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;MyHdformater.HdformatedStr is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span>
            <span class="n">MyHdformater</span><span class="o">.</span><span class="n">HdformatedStr</span><span class="p">)</span>
    <span class="p">]</span>
<span class="p">)</span> 
...
<p><small>
View the Capturer sources on <a href="https://github.com/Ledoux/ShareYourSystem/tree/master/ShareYourSystem/Interfacers/Capturer">Github</a>
</small></p>
</div>
</div>
</div></section><section>
...
<hr>
<p><small>
View the Processer notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Processer.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<p><small>
View the Processer sources on <a href="https://github.com/Ledoux/ShareYourSystem/tree/master/ShareYourSystem/Interfacers/Processer">Github</a>
</small></p>
</div>
</div>
</div></section><section>
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Interfacers</span> <span class="kn">import</span> <span class="n">Processer</span>

<span class="c">#Definition of an instance Processer and make it print hello</span>
<span class="n">MyProcesser</span><span class="o">=</span><span class="n">Processer</span><span class="o">.</span><span class="n">ProcesserClass</span><span class="p">()</span><span class="o">.</span><span class="n">process</span><span class="p">(</span><span class="s">&#39;which python &#39;</span><span class="p">,</span>
    <span class="o">**</span><span class="p">{</span>
    <span class="s">&#39;FolderingPathStr&#39;</span><span class="p">:</span><span class="n">Processer</span><span class="o">.</span><span class="n">LocalFolderPathStr</span>
    <span class="p">}</span>
<span class="p">)</span>
...
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;MyProcesser is &#39;</span><span class="o">+</span><span class="n">SYS</span><span class="o">.</span><span class="n">_str</span><span class="p">(</span><span class="n">MyProcesser</span><span class="p">)</span>
    <span class="p">]</span>
<span class="p">)</span> 
...
<hr>
<p><small>
View the Statuser notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Statuser.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Interfacers</span> <span class="kn">import</span> <span class="n">Statuser</span>
<span class="kn">import</span> <span class="nn">os</span>

<span class="c">#Definition a Statuser</span>
<span class="n">MyStatuser</span><span class="o">=</span><span class="n">Statuser</span><span class="o">.</span><span class="n">StatuserClass</span><span class="p">()</span><span class="o">.</span><span class="n">status</span><span class="p">(</span><span class="s">&#39;Python&#39;</span><span class="p">)</span>

<span class="c">#Definition the AttestedStr</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;MyStatuser is &#39;</span><span class="o">+</span><span class="n">SYS</span><span class="o">.</span><span class="n">_str</span><span class="p">(</span>
        <span class="n">MyStatuser</span><span class="p">,</span>
        <span class="o">**</span><span class="p">{</span>
            <span class="s">&#39;RepresentingBaseKeyStrsListBool&#39;</span><span class="p">:</span><span class="bp">False</span>
        <span class="p">}</span>
        <span class="p">)</span>
...
<hr>
<p><small>
View the Killer notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Killer.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<p><small>
View the Killer sources on <a href="https://github.com/Ledoux/ShareYourSystem/tree/master/ShareYourSystem/Interfacers/Killer">Github</a>
</small></p>
</div>
</div>
</div></section><section>
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Interfacers</span> <span class="kn">import</span> <span class="n">Killer</span>

<span class="c">#Definition a Killer</span>
<span class="n">MyKiller</span><span class="o">=</span><span class="n">Killer</span><span class="o">.</span><span class="n">KillerClass</span><span class="p">()</span><span class="o">.</span><span class="n">kill</span><span class="p">(</span><span class="o">**</span><span class="p">{</span><span class="s">&#39;StatusingProcessStr&#39;</span><span class="p">:</span><span class="s">&quot;Python&quot;</span><span class="p">})</span>

<span class="c">#Definition the AttestedStr</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;MyKiller is &#39;</span><span class="o">+</span><span class="n">SYS</span><span class="o">.</span><span class="n">_str</span><span class="p">(</span>
        <span class="n">MyKiller</span><span class="p">,</span>
        <span class="o">**</span><span class="p">{</span>
            <span class="s">&#39;RepresentingBaseKeyStrsListBool&#39;</span><span class="p">:</span><span class="bp">False</span><span class="p">,</span>
            <span class="s">&#39;RepresentingAlineaIsBool&#39;</span><span class="p">:</span><span class="bp">False</span>
        <span class="p">}</span>
...
<h1 id="directer">Directer</h1>
<h2 id="doc">Doc</h2>
<hr>
<blockquote>
<p>The Directer is a walker through the folders of the harddrive, 
assuring a call of _DirectingCallbackFunction at each level.</p>
</blockquote>
<hr>
<p><small>
View the Directer notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Directer.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<p><small>
View the Directer sources on <a href="https://github.com/Ledoux/ShareYourSystem/tree/master/ShareYourSystem/Interfacers/Directer">Github</a>
</small></p>
</div>
</div>
</div></section><section>
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Interfacers</span> <span class="kn">import</span> <span class="n">Directer</span>
<span class="kn">import</span> <span class="nn">os</span>

<span class="c">#Definition an instance </span>
<span class="n">MyDirecter</span><span class="o">=</span><span class="n">Directer</span><span class="o">.</span><span class="n">DirecterClass</span><span class="p">()</span>

<span class="c">#Direct for displaying folders</span>
<span class="sd">&#39;&#39;&#39;</span>
<span class="sd">MyDirecter.direct(</span>
<span class="sd">            lambda _LiargVariablesList,_FolderPathStr,_FileKeyStrsList:</span>
<span class="sd">            Representer._print(_LiargVariablesList[0]+_FolderPathStr),</span>
<span class="sd">            [&quot;_FolderPathStr is &quot;],</span>
<span class="sd">            **{&#39;FolderingPathStr&#39;:&#39;/&#39;.join(SYS.__file__.split(&#39;/&#39;)[:-1])}</span>
<span class="sd">        )</span>
<span class="sd">&#39;&#39;&#39;</span>

<span class="c">#Delete things</span>
<span class="k">def</span> <span class="nf">delete</span><span class="p">(</span><span class="n">_LiargVariablesList</span><span class="p">,</span><span class="n">_FolderPathStr</span><span class="p">,</span><span class="n">_FileKeyStrsList</span><span class="p">):</span>
    <span class="c">#os.popen(&#39;rm -r &#39;+_FolderPathStr+&#39;/Attests/&#39;)</span>
    <span class="n">os</span><span class="o">.</span><span class="n">popen</span><span class="p">(</span><span class="s">&#39;rm &#39;</span><span class="o">+</span><span class="n">_FolderPathStr</span><span class="o">+</span><span class="s">&#39;/02_ClassCell.md&#39;</span><span class="p">)</span>
    <span class="n">os</span><span class="o">.</span><span class="n">popen</span><span class="p">(</span><span class="s">&#39;rm &#39;</span><span class="o">+</span><span class="n">_FolderPathStr</span><span class="o">+</span><span class="s">&#39;/03_ClassCell.py&#39;</span><span class="p">)</span>
    <span class="n">os</span><span class="o">.</span><span class="n">popen</span><span class="p">(</span><span class="s">&#39;rm &#39;</span><span class="o">+</span><span class="n">_FolderPathStr</span><span class="o">+</span><span class="s">&#39;/04_InstanceCell.md&#39;</span><span class="p">)</span>
    <span class="n">os</span><span class="o">.</span><span class="n">popen</span><span class="p">(</span><span class="s">&#39;rm &#39;</span><span class="o">+</span><span class="n">_FolderPathStr</span><span class="o">+</span><span class="s">&#39;/05_InstanceCell.py&#39;</span><span class="p">)</span>
<span class="k">def</span> <span class="nf">move</span><span class="p">(</span><span class="n">_LiargVariablesList</span><span class="p">,</span><span class="n">_FolderPathStr</span><span class="p">,</span><span class="n">_FileKeyStrsList</span><span class="p">):</span>
    <span class="n">os</span><span class="o">.</span><span class="n">popen</span><span class="p">(</span><span class="s">&#39;mv &#39;</span><span class="o">+</span><span class="n">_FolderPathStr</span><span class="o">+</span><span class="s">&#39;/00_ExampleCell.md &#39;</span><span class="o">+</span><span class="n">_FolderPathStr</span><span class="o">+</span><span class="s">&#39;/00_ExampleDoc.md&#39;</span><span class="p">)</span>
    <span class="n">os</span><span class="o">.</span><span class="n">popen</span><span class="p">(</span><span class="s">&#39;mv &#39;</span><span class="o">+</span><span class="n">_FolderPathStr</span><span class="o">+</span><span class="s">&#39;/01_ExampleCell.py &#39;</span><span class="o">+</span><span class="n">_FolderPathStr</span><span class="o">+</span><span class="s">&#39;/01_ExampleDoc.py&#39;</span><span class="p">)</span>

<span class="n">MyDirecter</span><span class="o">=</span><span class="n">Directer</span><span class="o">.</span><span class="n">DirecterClass</span><span class="p">()</span><span class="o">.</span><span class="n">direct</span><span class="p">(</span>
            <span class="n">delete</span><span class="p">,</span>
            <span class="p">[],</span>
            <span class="o">**</span><span class="p">{</span>
                <span class="s">&#39;FolderingPathStr&#39;</span><span class="p">:</span>
                <span class="n">SYS</span><span class="o">.</span><span class="n">LocalShareYourSystemFolderPathStr</span><span class="o">+</span><span class="s">&#39;/ShareYourSystem/Guiders/&#39;</span>
            <span class="p">}</span>
        <span class="p">)</span>
...
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;MyDirecter is &#39;</span><span class="o">+</span><span class="n">SYS</span><span class="o">.</span><span class="n">_str</span><span class="p">(</span>
                <span class="n">MyDirecter</span><span class="p">,</span>
                <span class="o">**</span><span class="p">{</span>
                <span class="s">&#39;RepresentingBaseKeyStrsListBool&#39;</span><span class="p">:</span><span class="bp">False</span>
                <span class="p">}</span>
            <span class="p">)</span>
