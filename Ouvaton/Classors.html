...
<hr>
<blockquote>
<p>The Doer defines instances that are going to decorate a big family of classes in this framework. 
...
This helps a lot for defining a fisrt level of objects that are acting like input-output controllers.</p>
</blockquote>
<hr>
<p><small>
View the Doer notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Doer.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<p>It is possible to re set the Doing or Done attributes</p>
</div>
</div>
</div>
...
<span class="kn">from</span> <span class="nn">ShareYourSystem.Classors</span> <span class="kn">import</span> <span class="n">Doer</span><span class="p">,</span><span class="n">Attester</span> 
<span class="kn">from</span> <span class="nn">ShareYourSystem.Objects</span> <span class="kn">import</span> <span class="n">Initiator</span>

<span class="c">#Definition a MakerClass decorated by the DefaultorClass</span>
<span class="nd">@Doer.DoerClass</span><span class="p">()</span>
<span class="k">class</span> <span class="nc">MakerClass</span><span class="p">(</span><span class="n">Initiator</span><span class="o">.</span><span class="n">InitiatorClass</span><span class="p">):</span>

    <span class="k">def</span> <span class="nf">default_init</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span>
                <span class="n">_MakingMyFloat</span><span class="o">=</span><span class="mf">1.</span><span class="p">,</span>
                <span class="n">_MakingMyList</span><span class="o">=</span><span class="bp">None</span><span class="p">,</span>
                <span class="n">_MakingFirstInt</span><span class="o">=</span><span class="p">{</span><span class="s">&#39;DefaultingSetType&#39;</span><span class="p">:</span><span class="nb">int</span><span class="p">},</span>
                <span class="n">_MakingSecondInt</span><span class="o">=</span><span class="mi">0</span><span class="p">,</span>
                <span class="n">_MadeMyInt</span><span class="o">=</span><span class="mi">0</span><span class="p">,</span>
                <span class="n">_MadeMyList</span><span class="o">=</span><span class="bp">None</span><span class="p">,</span>
                <span class="p">):</span>
        <span class="k">pass</span>

    <span class="k">def</span> <span class="nf">do_make</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>

        <span class="c">#print</span>
        <span class="k">print</span><span class="p">(</span><span class="s">&#39;Maker : I am going to make&#39;</span><span class="p">)</span>
        <span class="k">print</span><span class="p">(</span><span class="s">&#39;self.MakingMyFloat is &#39;</span><span class="p">,</span><span class="bp">self</span><span class="o">.</span><span class="n">MakingMyFloat</span><span class="p">)</span>
        <span class="k">print</span><span class="p">(</span><span class="s">&#39;&#39;</span><span class="p">)</span>

        <span class="c">#set</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">MadeMyInt</span><span class="o">=</span><span class="nb">int</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">MakingMyFloat</span><span class="p">)</span>

        <span class="c">#Return self</span>
        <span class="c">#return self</span>

<span class="c">#Definition of an instance and make</span>
<span class="n">MyMaker</span><span class="o">=</span><span class="n">MakerClass</span><span class="p">(</span>
    <span class="n">_MakingMyList</span><span class="o">=</span><span class="p">[</span><span class="s">&#39;hello&#39;</span><span class="p">],</span>
    <span class="o">**</span><span class="p">{</span><span class="s">&#39;MakingFirstInt&#39;</span><span class="p">:</span><span class="mi">3</span><span class="p">}</span>
    <span class="p">)</span><span class="o">.</span><span class="n">superDo_make</span><span class="p">(</span>
        <span class="mf">3.</span><span class="p">,[</span><span class="s">&#39;bonjour&#39;</span><span class="p">],</span>
        <span class="n">_SecondInt</span><span class="o">=</span><span class="mi">5</span>
    <span class="p">)</span>

<span class="k">print</span><span class="p">(</span><span class="s">&#39;MyMaker is &#39;</span><span class="p">)</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_print</span><span class="p">(</span><span class="n">MyMaker</span><span class="p">)</span>

<span class="k">print</span><span class="p">(</span><span class="s">&#39;we reset doing&#39;</span><span class="p">)</span>
<span class="n">MyMaker</span><span class="o">.</span><span class="n">setDoing</span><span class="p">(</span><span class="n">MakerClass</span><span class="p">)</span>

<span class="k">print</span><span class="p">(</span><span class="s">&#39;MyMaker after set doing is &#39;</span><span class="p">)</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_print</span><span class="p">(</span><span class="n">MyMaker</span><span class="p">)</span>

<span class="c">#Add</span>
<span class="n">AttestingStrsList</span><span class="o">=</span><span class="p">[</span>
        <span class="s">&#39;MyMaker.__dict__ is &#39;</span><span class="o">+</span><span class="n">SYS</span><span class="o">.</span><span class="n">_str</span><span class="p">(</span><span class="n">MyMaker</span><span class="o">.</span><span class="n">__dict__</span><span class="p">,</span>
            <span class="o">**</span><span class="p">{</span><span class="s">&#39;RepresentingAlineaIsBool&#39;</span><span class="p">:</span><span class="bp">False</span><span class="p">})</span>
    <span class="p">]</span>

<span class="c">#Definition</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span><span class="n">AttestingStrsList</span><span class="p">)</span>
...
<h1 id="deriver">Deriver</h1>
<h2 id="doc">Doc</h2>
<hr>
<blockquote>
<p>The Deriver helps for building a base-derive relationships between the classes.
Once a <Class> with based classes is defined, a decorating DeriverClass instance
append to these corresponding BaseClasses the <Class> as a derived class.</p>
</blockquote>
<hr>
<p><small>
View the Deriver notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Deriver.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Classors</span> <span class="kn">import</span> <span class="n">Doer</span><span class="p">,</span><span class="n">Deriver</span><span class="p">,</span><span class="n">Attester</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Objects</span> <span class="kn">import</span> <span class="n">Initiator</span>

<span class="c">#Definition of a MakerClass decorated by a DoerClass instance</span>
<span class="nd">@Doer.DoerClass</span><span class="p">()</span>
<span class="k">class</span> <span class="nc">MakerClass</span><span class="p">(</span><span class="n">Initiator</span><span class="o">.</span><span class="n">InitiatorClass</span><span class="p">):</span>
    <span class="k">pass</span>

<span class="c">#Definition of a derived BuilderClass decorated by a Deriver</span>
<span class="nd">@Deriver.DeriverClass</span><span class="p">()</span>
<span class="k">class</span> <span class="nc">BuilderClass</span><span class="p">(</span><span class="n">MakerClass</span><span class="p">):</span>
    <span class="k">pass</span>

<span class="c">#Print</span>
<span class="c">#print(&#39;MakerClass.DerivedClassesList is &#39;+str(MakerClass.DerivedClassesList))</span>
...
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;MakerClass.DerivedClassesList is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">MakerClass</span><span class="o">.</span><span class="n">DerivedClassesList</span><span class="p">)</span>
    <span class="p">]</span>
<span class="p">)</span> 
...
<h1 id="propertiser">Propertiser</h1>
<h2 id="doc">Doc</h2>
<hr>
<blockquote>
<p>The Propertiser is an augmented Defaultor because it will set defaults attributes
possibly in properties for the new-style decorated classes. This can set objects
with high controlling features thanks to the binding </p>
</blockquote>
<hr>
<p><small>
View the Propertiser notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Propertiser.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<h2 id="example">Example</h2>
<p>Going back to the Doer cell when we invented a very minimalist Maker.
...
that will be linked to the fset attribute of the property object. </p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Classors</span> <span class="kn">import</span> <span class="n">Propertiser</span><span class="p">,</span><span class="n">Attester</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Objects</span> <span class="kn">import</span> <span class="n">Initiator</span>

<span class="c">#Definition a MakerClass decorated by the PropertiserClass</span>
<span class="nd">@Propertiser.PropertiserClass</span><span class="p">()</span>
<span class="k">class</span> <span class="nc">MakerClass</span><span class="p">(</span><span class="n">Initiator</span><span class="o">.</span><span class="n">InitiatorClass</span><span class="p">):</span>

    <span class="k">def</span> <span class="nf">default_init</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span>
            <span class="n">_MakingMyFloat</span><span class="o">=</span><span class="p">{</span>
                            <span class="s">&#39;DefaultingSetType&#39;</span><span class="p">:</span><span class="nb">property</span><span class="p">,</span>
                            <span class="s">&#39;PropertizingInitVariable&#39;</span><span class="p">:</span><span class="mf">3.</span><span class="p">,</span>
                            <span class="s">&#39;PropertizingDocStr&#39;</span><span class="p">:</span><span class="s">&#39;I am doing the thing here&#39;</span>
                            <span class="p">},</span>
            <span class="n">_MakingMyList</span><span class="o">=</span><span class="p">{</span>
                            <span class="s">&#39;DefaultingSetType&#39;</span><span class="p">:</span><span class="nb">property</span><span class="p">,</span>
                            <span class="s">&#39;PropertizingInitVariable&#39;</span><span class="p">:[],</span>
                            <span class="s">&#39;PropertizingDocStr&#39;</span><span class="p">:</span><span class="s">&#39;I am doing the thing here&#39;</span>
                            <span class="p">},</span>
            <span class="n">_MakingMyInt</span><span class="o">=</span><span class="p">{</span><span class="s">&#39;DefaultingSetType&#39;</span><span class="p">:</span><span class="nb">int</span><span class="p">},</span>
            <span class="n">_MadeMyInt</span><span class="o">=</span><span class="mi">0</span>
        <span class="p">):</span>
        <span class="k">pass</span>

    <span class="c">#Definition a binding function</span>
    <span class="k">def</span> <span class="nf">setMakingMyFloat</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span><span class="n">_SettingValueVariable</span><span class="p">):</span>

        <span class="c">#Print</span>
        <span class="c">#print(&#39;I am going to make the job directly !&#39;)</span>

        <span class="c">#set the value of the &quot;hidden&quot; property variable</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">_MakingMyFloat</span><span class="o">=</span><span class="n">_SettingValueVariable</span>

        <span class="c">#Bind with MadeInt setting</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">MadeMyInt</span><span class="o">=</span><span class="nb">int</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">_MakingMyFloat</span><span class="p">)</span>

    <span class="c">#Definition a binding function</span>
    <span class="k">def</span> <span class="nf">setMakingMyList</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span><span class="n">_SettingValueVariable</span><span class="p">):</span>

        <span class="c">#set the value of the &quot;hidden&quot; property variable</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">_MakingMyList</span><span class="o">=</span><span class="n">_SettingValueVariable</span><span class="o">+</span><span class="p">[</span><span class="s">&#39;Hellllllo&#39;</span><span class="p">]</span>


<span class="c">#Definition a default instance </span>
<span class="n">DefaultMaker</span><span class="o">=</span><span class="n">MakerClass</span><span class="p">()</span>

<span class="c">#Definition a special instance</span>
<span class="n">SpecialMaker</span><span class="o">=</span><span class="n">MakerClass</span><span class="p">(</span><span class="n">_MakingMyFloat</span><span class="o">=</span><span class="mi">5</span><span class="p">,</span><span class="n">_MakingMyList</span><span class="o">=</span><span class="p">[</span><span class="mi">4</span><span class="p">])</span>

<span class="c">#Definition the AttestedStr</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;MakerClass.PropertizedDefaultTuplesList is &#39;</span><span class="o">+</span><span class="n">SYS</span><span class="o">.</span><span class="n">_str</span><span class="p">(</span>
            <span class="n">MakerClass</span><span class="o">.</span><span class="n">PropertizedDefaultTuplesList</span><span class="p">),</span>
        <span class="s">&#39;What are you saying DefaultMaker ?&#39;</span><span class="p">,</span>
        <span class="s">&#39;DefaultMaker.__dict__ is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">DefaultMaker</span><span class="o">.</span><span class="n">__dict__</span><span class="p">),</span>
        <span class="s">&#39;DefaultMaker.MakingMyFloat is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">DefaultMaker</span><span class="o">.</span><span class="n">MakingMyFloat</span><span class="p">),</span>
        <span class="s">&#39;DefaultMaker.MakingMyList is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">DefaultMaker</span><span class="o">.</span><span class="n">MakingMyList</span><span class="p">),</span>
        <span class="s">&#39;DefaultMaker.MadeMyInt is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">DefaultMaker</span><span class="o">.</span><span class="n">MadeMyInt</span><span class="p">),</span>
        <span class="s">&#39;What are you saying SpecialMaker ?&#39;</span><span class="p">,</span>
        <span class="s">&#39;SpecialMaker.__dict__ is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">SpecialMaker</span><span class="o">.</span><span class="n">__dict__</span><span class="p">),</span>
        <span class="s">&#39;SpecialMaker.MakingMyFloat is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">SpecialMaker</span><span class="o">.</span><span class="n">MakingMyFloat</span><span class="p">),</span>
        <span class="s">&#39;SpecialMaker.MakingMyList is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">SpecialMaker</span><span class="o">.</span><span class="n">MakingMyList</span><span class="p">),</span>
        <span class="s">&#39;SpecialMaker.MadeMyInt is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">SpecialMaker</span><span class="o">.</span><span class="n">MadeMyInt</span><span class="p">),</span>
    <span class="p">]</span>
<span class="p">)</span> 
...
<hr>
<blockquote>
<p>An Inspecter decorates a class by giving it an InspectedArgumentDict that is 
an inspection of all defined methods.</p>
</blockquote>
<hr>
<p><small>
View the Inspecter notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Inspecter.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<h2 id="example">Example</h2>
<p>Let&#39;s create an empty class, which will automatically receive special attributes from the decorating ClassorClass specially the NameStr, that should be the ClassStr without the TypeStr in the end.</p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Classors</span> <span class="kn">import</span> <span class="n">Inspecter</span><span class="p">,</span><span class="n">Attester</span> 
<span class="kn">from</span> <span class="nn">ShareYourSystem.Objects</span> <span class="kn">import</span> <span class="n">Initiator</span>

<span class="c">#Definition a FooClass decorated by the ClassorClass</span>
<span class="nd">@Inspecter.InspecterClass</span><span class="p">()</span>
<span class="k">class</span> <span class="nc">MakerClass</span><span class="p">(</span><span class="n">Initiator</span><span class="o">.</span><span class="n">InitiatorClass</span><span class="p">):</span>
    <span class="k">def</span> <span class="nf">make</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span>
            <span class="n">_MakingStr</span><span class="p">,</span>
            <span class="n">_MakingInt</span><span class="o">=</span><span class="mi">0</span><span class="p">,</span>
            <span class="o">**</span><span class="n">_KwargVariablesDict</span>
        <span class="p">):</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">__class__</span><span class="o">.</span><span class="n">__bases__</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span><span class="o">.</span><span class="n">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span><span class="o">**</span><span class="n">_KwargVariablesDict</span><span class="p">)</span>

<span class="c">#Definition the AttestedStr</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;MakerClass.InspectedArgumentDict is &#39;</span><span class="o">+</span><span class="n">SYS</span><span class="o">.</span><span class="n">_str</span><span class="p">(</span><span class="n">MakerClass</span><span class="o">.</span><span class="n">InspectedArgumentDict</span><span class="p">)</span>
    <span class="p">]</span>
<span class="p">)</span> 
...
<h1 id="representer">Representer</h1>
<h2 id="doc">Doc</h2>
<hr>
<blockquote>
<p>The Representer is an important module for beginning to visualize 
...
a <strong>repr</strong> method, helping for mentionning for the represented attributes where
do they come from : <Spe> (resp. <Base>) is they were defined at the level of the __class__ 
and <Instance> (resp. <Class>) if they are getted from the <InstanceVariable>.<strong>dict</strong> 
(resp. <InstanceVariable>.<strong>class</strong>.<strong>dict</strong>)</p>
</blockquote>
<hr>
<p><small>
View the Representer notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Representer.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<h2 id="example">Example</h2>
<p>Then classes that are decorated by the representer have now a special <strong>repr</strong> method.</p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Classors</span> <span class="kn">import</span> <span class="n">Representer</span><span class="p">,</span><span class="n">Attester</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Objects</span> <span class="kn">import</span> <span class="n">Initiator</span>

<span class="c">#Represent a simple object</span>
<span class="nd">@Representer.RepresenterClass</span><span class="p">()</span>
<span class="k">class</span> <span class="nc">MakerClass</span><span class="p">(</span><span class="n">Initiator</span><span class="o">.</span><span class="n">InitiatorClass</span><span class="p">):</span>

    <span class="n">RepresentingKeyStrsList</span><span class="o">=</span><span class="p">[</span><span class="s">&#39;MadeMyInt&#39;</span><span class="p">]</span>

    <span class="k">def</span> <span class="nf">default_init</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span>
                        <span class="n">_MakingMyFloat</span><span class="o">=</span><span class="mf">0.</span><span class="p">,</span>  
                        <span class="n">_MadeMyInt</span><span class="o">=</span><span class="mi">0</span>
                    <span class="p">):</span>
        <span class="k">pass</span>

<span class="c">#Definition a simple instance</span>
<span class="n">SimpleMaker</span><span class="o">=</span><span class="n">MakerClass</span><span class="p">(</span><span class="n">_MakingMyFloat</span><span class="o">=</span><span class="mf">2.</span><span class="p">)</span>

<span class="c">#Represent a structured instance</span>
<span class="n">ParentMaker</span><span class="o">=</span><span class="n">MakerClass</span><span class="p">()</span>
<span class="n">ParentMaker</span><span class="o">.</span><span class="n">FirstChildMaker</span><span class="o">=</span><span class="n">MakerClass</span><span class="p">()</span>
<span class="n">ParentMaker</span><span class="o">.</span><span class="n">CircularChildMaker</span><span class="o">=</span><span class="n">MakerClass</span><span class="p">()</span>
<span class="n">ParentMaker</span><span class="o">.</span><span class="n">CircularChildMaker</span><span class="o">.</span><span class="n">ParentMaker</span><span class="o">=</span><span class="n">ParentMaker</span>
<span class="n">ParentMaker</span><span class="o">.</span><span class="n">CircularChildMaker</span><span class="o">.</span><span class="n">SelfMaker</span><span class="o">=</span><span class="n">ParentMaker</span><span class="o">.</span><span class="n">CircularChildMaker</span>

<span class="c">#Definition a derived class from the MakerClass</span>
<span class="nd">@Representer.RepresenterClass</span><span class="p">()</span>
<span class="k">class</span> <span class="nc">BuilderClass</span><span class="p">(</span><span class="n">MakerClass</span><span class="p">):</span>

    <span class="n">RepresentingKeyStrsList</span><span class="o">=</span><span class="p">[</span><span class="s">&#39;BuiltMyStr&#39;</span><span class="p">]</span>

    <span class="k">def</span> <span class="nf">default_init</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span>
                        <span class="n">_BuildingMyStr</span><span class="o">=</span><span class="s">&#39;hello&#39;</span><span class="p">,</span>  
                        <span class="n">_BuiltMyStr</span><span class="o">=</span><span class="s">&#39;None&#39;</span>
                    <span class="p">):</span>
        <span class="k">pass</span>

<span class="c">#Definition a simple instance</span>
<span class="n">SimpleBuilder</span><span class="o">=</span><span class="n">BuilderClass</span><span class="p">(</span><span class="n">_MakingMyFloat</span><span class="o">=</span><span class="mf">2.</span><span class="p">)</span>

<span class="c">#Definition the AttestedStr</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;SimpleMaker is &#39;</span><span class="o">+</span><span class="n">SYS</span><span class="o">.</span><span class="n">_str</span><span class="p">(</span><span class="n">SimpleMaker</span><span class="p">),</span>
        <span class="s">&#39;ParentMaker is &#39;</span><span class="o">+</span><span class="n">SYS</span><span class="o">.</span><span class="n">_str</span><span class="p">(</span><span class="n">ParentMaker</span><span class="p">),</span>
        <span class="s">&#39;SimpleBuilder is &#39;</span><span class="o">+</span><span class="n">SYS</span><span class="o">.</span><span class="n">_str</span><span class="p">(</span><span class="n">SimpleBuilder</span><span class="p">)</span>
    <span class="p">]</span>
<span class="p">)</span> 
...
<h1 id="attester">Attester</h1>
<h2 id="doc">Doc</h2>
<hr>
<blockquote>
<p>The Attester helps for outputing and writing
...
<hr>
<p><small>
View the Attester notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Attester.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<h2 id="example">Example</h2>
<p>Here we just decorate an IncrementerClass with an Attester and define an attest_increment
...
<span class="kn">from</span> <span class="nn">ShareYourSystem.Tutorials</span> <span class="kn">import</span> <span class="n">Incrementer</span>

<span class="c">#Attest the module</span>
<span class="n">Incrementer</span><span class="o">.</span><span class="n">IncrementerClass</span><span class="p">()</span><span class="o">.</span><span class="n">setAttest</span><span class="p">(</span>
    <span class="n">Attester</span><span class="o">.</span><span class="n">AttesterClass</span><span class="o">.</span><span class="n">DeriveClassor</span><span class="o">.</span><span class="n">AttestingFolderPathStr</span>
<span class="p">)</span>

<span class="c">#Definition the AttestedStr</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
<span class="s">&#39;Attests file is written and is &#39;</span><span class="o">+</span><span class="nb">open</span><span class="p">(</span>
    <span class="n">Attester</span><span class="o">.</span><span class="n">AttesterClass</span><span class="o">.</span><span class="n">DeriveClassor</span><span class="o">.</span><span class="n">AttestingFolderPathStr</span><span class="o">+</span><span class="s">&#39;attest_increment.txt&#39;</span>
...
<hr>
<blockquote>
<p>The Tester helps for defining asserts between 
...
<a href="https://docs.python.org/2/library/unittest.html">https://docs.python.org/2/library/unittest.html</a></p>
</blockquote>
<hr>
<p><small>
View the Tester notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Tester.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<h2 id="example">Example</h2>
<p>The Incrementer from the previous Attester Module is now tested from its corresponding attesting function
attest_increment. Here a test_increment method is implicitely defined in a unittest class and when we call
the test method, a unittest.run is done.</p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Classors</span> <span class="kn">import</span> <span class="n">Tester</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Tutorials</span> <span class="kn">import</span> <span class="n">Decrementer</span>

<span class="c">#Attest the module</span>
<span class="n">Decrementer</span><span class="o">.</span><span class="n">DecrementerClass</span><span class="p">()</span><span class="o">.</span><span class="n">setAttest</span><span class="p">(</span>
    <span class="n">Tester</span><span class="o">.</span><span class="n">TesterClass</span><span class="o">.</span><span class="n">DeriveClassor</span><span class="o">.</span><span class="n">AttestingFolderPathStr</span>
<span class="p">)</span>
<span class="n">Decrementer</span><span class="o">.</span><span class="n">test</span><span class="p">()</span>
...
<hr>
<p><small>
View the Observer notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Observer.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<h2 id="example">Example</h2>
<p>For this non directly very useful Module we just define a decorated FooClass
for which the Functer decoration by default call the decorated method...</p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Classors</span> <span class="kn">import</span> <span class="n">Observer</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Objects</span> <span class="kn">import</span> <span class="n">Initiator</span>
<span class="kn">import</span> <span class="nn">operator</span>

<span class="c">#Definition a MakerClass decorated by the ObserverClass</span>
<span class="nd">@Observer.ObserverClass</span><span class="p">(</span><span class="o">**</span><span class="p">{</span>
    <span class="s">&#39;ObservingIsBool&#39;</span><span class="p">:</span><span class="bp">True</span><span class="p">,</span>
    <span class="s">&#39;ObservingWrapMethodStr&#39;</span><span class="p">:</span><span class="s">&#39;make&#39;</span>
<span class="p">})</span>
<span class="k">class</span> <span class="nc">MakerClass</span><span class="p">(</span><span class="n">Initiator</span><span class="o">.</span><span class="n">InitiatorClass</span><span class="p">):</span>

    <span class="c">#Definition</span>
    <span class="n">RepresentingKeyStrsList</span><span class="o">=</span><span class="p">[</span>
                                <span class="s">&#39;MakingMyFloat&#39;</span><span class="p">,</span>
                                <span class="s">&#39;MadeMyInt&#39;</span>
                            <span class="p">]</span>

    <span class="k">def</span> <span class="nf">default_init</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span>
                    <span class="n">_MakingMyFloat</span><span class="o">=</span><span class="mf">0.</span><span class="p">,</span>
                    <span class="n">_MadeMyInt</span><span class="o">=</span><span class="mi">0</span><span class="p">,</span>
                    <span class="o">**</span><span class="n">_KwarVariablesDict</span>
                <span class="p">):</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">__class__</span><span class="o">.</span><span class="n">__bases__</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span><span class="o">.</span><span class="n">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span><span class="o">**</span><span class="n">_KwarVariablesDict</span><span class="p">)</span>
...
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;MakerClass.make is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">MakerClass</span><span class="o">.</span><span class="n">make</span><span class="p">),</span>
        <span class="s">&#39;MakerClass.DeriveClassor.ObservingWrapMethodStr is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span>
            <span class="n">MakerClass</span><span class="o">.</span><span class="n">DeriveClassor</span><span class="o">.</span><span class="n">ObservingWrapMethodStr</span><span class="p">),</span>
        <span class="s">&#39;MakerClass.DeriveClassor.ObservedWrapMethodStr is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span>
            <span class="n">MakerClass</span><span class="o">.</span><span class="n">DeriveClassor</span><span class="o">.</span><span class="n">ObservedWrapMethodStr</span><span class="p">),</span>
    <span class="p">]</span>
<span class="p">)</span> 
...
<h2 id="example">Example</h2>
<p>Here this is to check that the class checks that 
this is useless to watch a watch method, therefore it
just lets it as the first version. </p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Classors</span> <span class="kn">import</span> <span class="n">Binder</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Objects</span> <span class="kn">import</span> <span class="n">Initiator</span>
<span class="kn">import</span> <span class="nn">operator</span>

<span class="c">#Define a Unbound method like function</span>
<span class="k">def</span> <span class="nf">foo</span><span class="p">(</span><span class="n">_InstanceVariable</span><span class="p">,</span><span class="o">*</span><span class="n">_LiargVariablesList</span><span class="p">,</span><span class="o">**</span><span class="n">_KwargVariablesDict</span><span class="p">):</span>

    <span class="c">#print</span>
    <span class="k">print</span><span class="p">(</span><span class="s">&#39;In the foo function &#39;</span><span class="p">)</span>
    <span class="k">print</span><span class="p">(</span><span class="s">&#39;_KwargVariablesDict is &#39;</span><span class="p">)</span>
    <span class="k">print</span><span class="p">(</span><span class="n">_KwargVariablesDict</span><span class="p">)</span>
    <span class="k">print</span><span class="p">(</span><span class="s">&#39;&#39;</span><span class="p">)</span>

    <span class="c">#get the wrapped method</span>
    <span class="n">WrapUnboundMethod</span><span class="o">=</span><span class="nb">getattr</span><span class="p">(</span>
        <span class="nb">getattr</span><span class="p">(</span>
            <span class="n">SYS</span><span class="p">,</span>
            <span class="n">_KwargVariablesDict</span><span class="p">[</span><span class="s">&#39;BindDoClassStr&#39;</span><span class="p">]</span>
        <span class="p">),</span>
        <span class="n">_KwargVariablesDict</span><span class="p">[</span><span class="s">&#39;BindObserveWrapMethodStr&#39;</span><span class="p">]</span>
    <span class="p">)</span>

    <span class="c">#call</span>
    <span class="n">WrapUnboundMethod</span><span class="p">(</span><span class="n">_InstanceVariable</span><span class="p">,</span><span class="mf">10.</span><span class="o">*</span><span class="n">_InstanceVariable</span><span class="o">.</span><span class="n">MakingMyFloat</span><span class="p">)</span>


<span class="c">#Definition a MakerClass decorated by the BinderClass</span>
<span class="nd">@Binder.BinderClass</span><span class="p">(</span><span class="o">**</span><span class="p">{</span>
    <span class="s">&#39;ObservingWrapMethodStr&#39;</span><span class="p">:</span><span class="s">&#39;make&#39;</span><span class="p">,</span>
    <span class="s">&#39;BindingIsBool&#39;</span><span class="p">:</span><span class="bp">True</span><span class="p">,</span>
    <span class="s">&#39;BindingDecorationUnboundMethod&#39;</span><span class="p">:</span><span class="n">foo</span><span class="p">,</span>
    <span class="s">&#39;BindingItemTuplesList&#39;</span><span class="p">:[(</span><span class="s">&#39;MyFooInt&#39;</span><span class="p">,</span><span class="mi">1</span><span class="p">)]</span>
<span class="p">})</span>
<span class="k">class</span> <span class="nc">MakerClass</span><span class="p">(</span><span class="n">Initiator</span><span class="o">.</span><span class="n">InitiatorClass</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">do_make</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        ...
        <span class="c">#Print</span>
        <span class="k">print</span><span class="p">(</span><span class="s">&#39;I make&#39;</span><span class="p">)</span>
    
        <span class="c">#cast</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">MadeMyInt</span><span class="o">=</span><span class="nb">int</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">MakingMyFloat</span><span class="p">)</span>

<span class="c">#Definition and do a first make</span>
<span class="n">MyMaker</span><span class="o">=</span><span class="n">MakerClass</span><span class="p">()</span><span class="o">.</span><span class="n">make</span><span class="p">(</span><span class="mf">3.</span><span class="p">)</span>

<span class="c">#Use the other binded method that is completely fooooo</span>
<span class="n">MyMaker</span><span class="o">.</span><span class="n">foo_make</span><span class="p">()</span>

<span class="c">#Definition the AttestedStr</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;MakerClass.foo is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">MakerClass</span><span class="o">.</span><span class="n">foo</span><span class="p">),</span>
        <span class="s">&#39;MakerClass.foo_make is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">MakerClass</span><span class="o">.</span><span class="n">foo_make</span><span class="p">),</span>
...
<hr>
<p><small>
View the Watcher notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Watcher.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Classors</span> <span class="kn">import</span> <span class="n">Watcher</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Objects</span> <span class="kn">import</span> <span class="n">Initiator</span>

<span class="c">#Definition a MakerClass with decorated make by a Watcher</span>
<span class="nd">@Watcher.WatcherClass</span><span class="p">(</span><span class="o">**</span><span class="p">{</span>
    <span class="s">&#39;WatchingIsBool&#39;</span><span class="p">:</span><span class="bp">True</span><span class="p">,</span>
    <span class="c">#&#39;ObservingWrapMethodStr&#39;:&#39;do_make&#39;</span>
    <span class="c">#&#39;ObservingWrapMethodStr&#39;:&#39;superDo_make&#39;</span>
    <span class="s">&#39;ObservingWrapMethodStr&#39;</span><span class="p">:</span><span class="s">&#39;make&#39;</span>
    <span class="p">})</span>
<span class="k">class</span> <span class="nc">MakerClass</span><span class="p">(</span><span class="n">Initiator</span><span class="o">.</span><span class="n">InitiatorClass</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">default_init</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span>
                ...
                <span class="n">_MadeMyInt</span><span class="o">=</span><span class="mi">0</span>
                <span class="p">):</span>
        <span class="n">Initiator</span><span class="o">.</span><span class="n">InitiatorClass</span><span class="o">.</span><span class="n">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span>

    <span class="k">def</span> <span class="nf">do_make</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>

        <span class="c">#print</span>
        <span class="k">print</span><span class="p">(</span><span class="s">&#39;self.MakingMyFloat is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">MakingMyFloat</span><span class="p">))</span>
        <span class="k">print</span><span class="p">(</span><span class="s">&#39;self.MadeMyInt is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">MadeMyInt</span><span class="p">))</span>
        <span class="k">print</span><span class="p">(</span><span class="s">&#39;&#39;</span><span class="p">)</span>
...
<span class="k">class</span> <span class="nc">BuilderClass</span><span class="p">(</span><span class="n">MakerClass</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">default_init</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span>
                <span class="p">):</span>
        <span class="n">MakerClass</span><span class="o">.</span><span class="n">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span>

    <span class="k">def</span> <span class="nf">do_buid</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        <span class="k">pass</span>

<span class="c">#Definition an instance</span>
<span class="n">MyBuilder</span><span class="o">=</span><span class="n">MakerClass</span><span class="p">()</span>

<span class="c">#Print</span>
<span class="k">print</span><span class="p">(</span><span class="s">&#39;Before make, MyBuilder is &#39;</span><span class="p">)</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_print</span><span class="p">(</span><span class="n">MyBuilder</span><span class="p">)</span>

<span class="c">#make once</span>
<span class="n">MyBuilder</span><span class="o">.</span><span class="n">make</span><span class="p">(</span><span class="mf">3.</span><span class="p">)</span>

<span class="c">#Print</span>
<span class="k">print</span><span class="p">(</span><span class="s">&#39;After the first make, MyBuilder is &#39;</span><span class="p">)</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_print</span><span class="p">(</span><span class="n">MyBuilder</span><span class="p">)</span>

<span class="c">#Definition the AttestedStr</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;BuilderClass.make is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">BuilderClass</span><span class="o">.</span><span class="n">make</span><span class="p">),</span>
        <span class="s">&#39;MyBuilder is &#39;</span><span class="o">+</span><span class="n">SYS</span><span class="o">.</span><span class="n">_str</span><span class="p">(</span>
            <span class="n">MyBuilder</span><span class="p">,</span><span class="o">**</span><span class="p">{</span><span class="s">&#39;RepresentingAlineaIsBool&#39;</span><span class="p">:</span><span class="bp">False</span><span class="p">}</span>
        <span class="p">)</span>
    <span class="p">]</span>
<span class="p">)</span> 
...
<hr>
<p><small>
View the Resetter notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Resetter.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Classors</span> <span class="kn">import</span> <span class="n">Resetter</span><span class="p">,</span><span class="n">Attester</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Objects</span> <span class="kn">import</span> <span class="n">Initiator</span>

<span class="c">#Definition a MakerClass with decorated make by a Switcher</span>
<span class="nd">@Resetter.ResetterClass</span><span class="p">()</span>
<span class="k">class</span> <span class="nc">MakerClass</span><span class="p">(</span><span class="n">Initiator</span><span class="o">.</span><span class="n">InitiatorClass</span><span class="p">):</span>
...
<span class="k">class</span> <span class="nc">BuilderClass</span><span class="p">(</span><span class="n">MakerClass</span><span class="p">):</span>
    ...
    <span class="c">#Definition</span>
    <span class="n">RepresentingKeyStrsList</span><span class="o">=</span><span class="p">[</span>
                                <span class="s">&#39;BuildingMyStr&#39;</span><span class="p">,</span>
                                <span class="s">&#39;BuiltMyStr&#39;</span>
                            <span class="p">]</span>

    <span class="k">def</span> <span class="nf">default_init</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span>
                <span class="n">_BuildingMyStr</span><span class="o">=</span><span class="s">&quot;&quot;</span><span class="p">,</span>
                <span class="n">_BuiltMyStr</span><span class="o">=</span><span class="s">&quot;&quot;</span>
                <span class="p">):</span>
        <span class="n">MakerClass</span><span class="o">.</span><span class="n">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span>

    <span class="k">def</span> <span class="nf">do_build</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        <span class="c">#set</span>
        <span class="k">pass</span>

<span class="c">#Definition an instance</span>
<span class="n">MyBuilder</span><span class="o">=</span><span class="n">BuilderClass</span><span class="p">()</span>

<span class="c">#Print</span>
<span class="k">print</span><span class="p">(</span><span class="s">&#39;Before make, MyBuilder is &#39;</span><span class="p">)</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_print</span><span class="p">(</span><span class="n">MyBuilder</span><span class="p">,</span><span class="o">**</span><span class="p">{</span>
    <span class="s">&#39;RepresentingKeyStrsList&#39;</span><span class="p">:[</span><span class="s">&#39;MakingMyFloat&#39;</span><span class="p">,</span><span class="s">&#39;MadeMyInt&#39;</span><span class="p">]</span>
<span class="p">})</span>
...
<span class="c">#make again</span>
<span class="n">MyBuilder</span><span class="o">.</span><span class="n">make</span><span class="p">(</span><span class="mf">5.</span><span class="p">)</span>

<span class="c">#Print</span>
<span class="k">print</span><span class="p">(</span><span class="s">&#39;After the second make, MyBuilder is &#39;</span><span class="p">)</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_print</span><span class="p">(</span><span class="n">MyBuilder</span><span class="p">,</span><span class="o">**</span><span class="p">{</span>
    <span class="s">&#39;RepresentingKeyStrsList&#39;</span><span class="p">:[</span><span class="s">&#39;MakingMyFloat&#39;</span><span class="p">,</span><span class="s">&#39;MadeMyInt&#39;</span><span class="p">]</span>
<span class="p">})</span>

<span class="c">#make again</span>
<span class="k">print</span><span class="p">(</span><span class="s">&#39;Now we reset&#39;</span><span class="p">)</span>
<span class="n">MyBuilder</span><span class="o">.</span><span class="n">WatchMakeWithMakerBool</span><span class="o">=</span><span class="bp">False</span>

<span class="c">#Print</span>
<span class="k">print</span><span class="p">(</span><span class="s">&#39;After the reset MyBuilder is &#39;</span><span class="p">)</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_print</span><span class="p">(</span><span class="n">MyBuilder</span><span class="p">,</span><span class="o">**</span><span class="p">{</span>
    <span class="s">&#39;RepresentingKeyStrsList&#39;</span><span class="p">:[</span><span class="s">&#39;MakingMyFloat&#39;</span><span class="p">,</span><span class="s">&#39;MadeMyInt&#39;</span><span class="p">]</span>
<span class="p">})</span>

<span class="c">#make again</span>
<span class="n">MyBuilder</span><span class="o">.</span><span class="n">make</span><span class="p">(</span><span class="mf">7.</span><span class="p">)</span>

<span class="c">#Print</span>
<span class="k">print</span><span class="p">(</span><span class="s">&#39;After the third make, MyBuilder is &#39;</span><span class="p">)</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_print</span><span class="p">(</span><span class="n">MyBuilder</span><span class="p">,</span><span class="o">**</span><span class="p">{</span>
    <span class="s">&#39;RepresentingKeyStrsList&#39;</span><span class="p">:[</span><span class="s">&#39;MakingMyFloat&#39;</span><span class="p">,</span><span class="s">&#39;MadeMyInt&#39;</span><span class="p">]</span>
<span class="p">})</span>
...
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;BuilderClass.WatchMakeWithMakerBool is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">BuilderClass</span><span class="o">.</span><span class="n">WatchMakeWithMakerBool</span><span class="p">),</span>
        <span class="s">&#39;BuilderClass.setResetBoolWithMaker_ is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">BuilderClass</span><span class="o">.</span><span class="n">setResetBoolWithMaker_</span><span class="p">),</span>
        <span class="s">&#39;BuilderClass.make is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">BuilderClass</span><span class="o">.</span><span class="n">make</span><span class="p">),</span>
        <span class="s">&#39;MyBuilder is &#39;</span><span class="o">+</span><span class="n">SYS</span><span class="o">.</span><span class="n">_str</span><span class="p">(</span>
            <span class="n">MyBuilder</span><span class="p">,</span><span class="o">**</span><span class="p">{</span>
            <span class="s">&#39;RepresentingAlineaIsBool&#39;</span><span class="p">:</span><span class="bp">False</span><span class="p">,</span>
            <span class="s">&#39;RepresentingKeyStrsList&#39;</span><span class="p">:[</span>
                <span class="s">&#39;MakingMyFloat&#39;</span><span class="p">,</span><span class="s">&#39;MadeMyInt&#39;</span>
            <span class="p">]</span>
            <span class="p">}</span>
        <span class="p">),</span>
    <span class="p">]</span>
...
BuilderClass.setResetBoolWithMaker_ is &lt;unbound method BuilderClass.setResetBoolWithMaker_&gt;
...
<hr>
<p><small>
View the Switcher notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Switcher.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Classors</span> <span class="kn">import</span> <span class="n">Switcher</span><span class="p">,</span><span class="n">Attester</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Objects</span> <span class="kn">import</span> <span class="n">Initiator</span>

<span class="c">#Definition a MakerClass with decorated make by a Switcher</span>
<span class="nd">@Switcher.SwitcherClass</span><span class="p">(</span><span class="o">**</span><span class="p">{</span>
    <span class="s">&#39;SwitchingIsBool&#39;</span><span class="p">:</span><span class="bp">True</span><span class="p">,</span>
    <span class="c">#&#39;ObservingWrapMethodStr&#39;:&#39;do_make&#39;</span>
    <span class="c">#&#39;ObservingWrapMethodStr&#39;:&#39;superDo_make&#39;</span>
    <span class="s">&#39;SwitchingWrapMethodStr&#39;</span><span class="p">:</span><span class="s">&#39;make&#39;</span>
<span class="p">})</span>
<span class="k">class</span> <span class="nc">MakerClass</span><span class="p">(</span><span class="n">Initiator</span><span class="o">.</span><span class="n">InitiatorClass</span><span class="p">):</span>
...
<span class="c">#Print</span>
<span class="k">print</span><span class="p">(</span><span class="s">&#39;Before make, MyMaker is &#39;</span><span class="p">)</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_print</span><span class="p">(</span><span class="n">MyMaker</span><span class="p">)</span>

<span class="c">#make once</span>
<span class="n">MyMaker</span><span class="o">.</span><span class="n">make</span><span class="p">(</span><span class="mf">3.</span><span class="p">)</span>

<span class="c">#Print</span>
<span class="k">print</span><span class="p">(</span><span class="s">&#39;After the first make, MyMaker is &#39;</span><span class="p">)</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_print</span><span class="p">(</span><span class="n">MyMaker</span><span class="p">)</span>

<span class="c">#make again</span>
<span class="n">MyMaker</span><span class="o">.</span><span class="n">make</span><span class="p">(</span><span class="mf">5.</span><span class="p">)</span>

<span class="c">#Print</span>
<span class="k">print</span><span class="p">(</span><span class="s">&#39;After the second make, MyMaker is &#39;</span><span class="p">)</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_print</span><span class="p">(</span><span class="n">MyMaker</span><span class="p">)</span>

<span class="c">#make again</span>
<span class="k">print</span><span class="p">(</span><span class="s">&#39;Now we switch&#39;</span><span class="p">)</span>
<span class="n">MyMaker</span><span class="o">.</span><span class="n">setSwitch</span><span class="p">()</span>

<span class="c">#Print</span>
<span class="k">print</span><span class="p">(</span><span class="s">&#39;After the switch MyMaker is &#39;</span><span class="p">)</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_print</span><span class="p">(</span><span class="n">MyMaker</span><span class="p">)</span>

<span class="c">#make again</span>
<span class="n">MyMaker</span><span class="o">.</span><span class="n">make</span><span class="p">(</span><span class="mf">7.</span><span class="p">)</span>

<span class="c">#Print</span>
<span class="k">print</span><span class="p">(</span><span class="s">&#39;After the third make, MyMaker is &#39;</span><span class="p">)</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_print</span><span class="p">(</span><span class="n">MyMaker</span><span class="p">)</span>
...
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;MakerClass.make is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">MakerClass</span><span class="o">.</span><span class="n">make</span><span class="p">),</span>
        <span class="s">&#39;MyMaker is &#39;</span><span class="o">+</span><span class="n">SYS</span><span class="o">.</span><span class="n">_str</span><span class="p">(</span>
            <span class="n">MyMaker</span><span class="p">,</span><span class="o">**</span><span class="p">{</span><span class="s">&#39;RepresentingAlineaIsBool&#39;</span><span class="p">:</span><span class="bp">False</span><span class="p">}</span>
        <span class="p">),</span>
    <span class="p">]</span>
<span class="p">)</span> 
...
<hr>
<p><small>
View the Mimicker notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Mimicker.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<h2 id="example">Example</h2>
<p>It is possible to cumulate mimick and switch properties...
Note that only the do_make is a switched method as the 
mimic_make continue to work after the first call of make.</p>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Classors</span> <span class="kn">import</span> <span class="n">Switcher</span><span class="p">,</span><span class="n">Mimicker</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Objects</span> <span class="kn">import</span> <span class="n">Initiator</span>
...
<span class="c">#Definition</span>
<span class="nd">@Mimicker.MimickerClass</span><span class="p">(</span><span class="o">**</span><span class="p">{</span>
    <span class="s">&#39;MimickingDoMethodStr&#39;</span><span class="p">:</span><span class="s">&quot;make&quot;</span>
<span class="p">})</span>
<span class="k">class</span> <span class="nc">BuilderClass</span><span class="p">(</span><span class="n">MakerClass</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">default_init</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span>
                    <span class="o">**</span><span class="n">_KwarVariablesDict</span>
                <span class="p">):</span>
        <span class="n">MakerClass</span><span class="o">.</span><span class="n">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span><span class="o">**</span><span class="n">_KwarVariablesDict</span><span class="p">)</span>

    <span class="k">def</span> <span class="nf">mimic_make</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
    
        <span class="c">#print</span>
        <span class="k">print</span><span class="p">(</span><span class="s">&#39;I am in the mimic_make of the Builder&#39;</span><span class="p">)</span>

        <span class="c">#call the parent method</span>
        <span class="n">MakerClass</span><span class="o">.</span><span class="n">make</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span>

        <span class="c">#cast</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">MadeMyInt</span><span class="o">+=</span><span class="mi">10</span>
...
<span class="n">SYS</span><span class="o">.</span><span class="n">_print</span><span class="p">(</span><span class="n">MyBuilder</span><span class="p">,</span><span class="o">**</span><span class="p">{</span>
    <span class="s">&#39;RepresentingKeyStrsList&#39;</span><span class="p">:[</span>
    <span class="s">&#39;MakingMyFloat&#39;</span><span class="p">,</span>
    <span class="s">&#39;MadeMyInt&#39;</span><span class="p">]</span>
<span class="p">})</span>
...
<span class="c">#make again</span>
<span class="k">print</span><span class="p">(</span><span class="s">&#39;Now we switch&#39;</span><span class="p">)</span>
<span class="n">MyBuilder</span><span class="o">.</span><span class="n">setSwitch</span><span class="p">(</span><span class="s">&#39;Maker&#39;</span><span class="p">,[</span><span class="s">&#39;Make&#39;</span><span class="p">])</span>

<span class="c">#Print</span>
<span class="k">print</span><span class="p">(</span><span class="s">&#39;After the switch MyBuilder is &#39;</span><span class="p">)</span>
<span class="n">SYS</span><span class="o">.</span><span class="n">_print</span><span class="p">(</span><span class="n">MyBuilder</span><span class="p">,</span><span class="o">**</span><span class="p">{</span>
    <span class="s">&#39;RepresentingKeyStrsList&#39;</span><span class="p">:[</span>
    <span class="s">&#39;MakingMyFloat&#39;</span><span class="p">,</span>
    <span class="s">&#39;MadeMyInt&#39;</span>
...
<span class="n">SYS</span><span class="o">.</span><span class="n">_print</span><span class="p">(</span><span class="n">MyBuilder</span><span class="p">,</span><span class="o">**</span><span class="p">{</span>
    ...
    <span class="s">&#39;MakingMyFloat&#39;</span><span class="p">,</span>
    <span class="s">&#39;MadeMyInt&#39;</span><span class="p">,</span>
    <span class="s">&#39;WatchMakeWithMakerBool&#39;</span><span class="p">]</span>
<span class="p">})</span>
...
<hr>
<p><small>
View the Classer notebook on <a href="http://nbviewer.ipython.org/url/shareyoursystem.ouvaton.org/Classer.ipynb">NbViewer</a>
</small></p>
</div>
</div>
</div></section><section>
...
<div class="highlight"><pre><span class="c">#ImportModules</span>
<span class="kn">import</span> <span class="nn">ShareYourSystem</span> <span class="kn">as</span> <span class="nn">SYS</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Classors</span> <span class="kn">import</span> <span class="n">Doer</span><span class="p">,</span><span class="n">Classer</span>
<span class="kn">from</span> <span class="nn">ShareYourSystem.Objects</span> <span class="kn">import</span> <span class="n">Initiator</span>
<span class="kn">import</span> <span class="nn">operator</span>

<span class="c">#Definition </span>
<span class="nd">@Classer.ClasserClass</span><span class="p">(</span><span class="o">**</span><span class="p">{</span>
    <span class="s">&#39;ClassingSwitchMethodStrsList&#39;</span><span class="p">:[</span>
...
<span class="k">class</span> <span class="nc">MakerClass</span><span class="p">(</span><span class="n">Initiator</span><span class="o">.</span><span class="n">InitiatorClass</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">default_init</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span>
                    ...
                    <span class="o">**</span><span class="n">_KwarVariablesDict</span>
                <span class="p">):</span>
        <span class="n">Initiator</span><span class="o">.</span><span class="n">InitiatorClass</span><span class="o">.</span><span class="n">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span><span class="o">**</span><span class="n">_KwarVariablesDict</span><span class="p">)</span>

    <span class="k">def</span> <span class="nf">do_make</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
    
        <span class="c">#print</span>
        <span class="k">print</span><span class="p">(</span><span class="s">&#39;I am in the do_make of the Maker&#39;</span><span class="p">)</span>
...
<span class="c">#make again</span>
<span class="k">print</span><span class="p">(</span><span class="s">&#39;Now we switch&#39;</span><span class="p">)</span>
<span class="n">MyBuilder</span><span class="o">.</span><span class="n">setSwitch</span><span class="p">(</span><span class="s">&#39;Builder&#39;</span><span class="p">,[</span><span class="s">&#39;Make&#39;</span><span class="p">])</span>
<span class="n">MyBuilder</span><span class="o">.</span><span class="n">callAllMro</span><span class="p">(</span><span class="s">&#39;setSwitch&#39;</span><span class="p">,[</span><span class="s">&#39;Make&#39;</span><span class="p">])</span>
...
<span class="n">SYS</span><span class="o">.</span><span class="n">_attest</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="s">&#39;BuilderClass.WatchMakeWithMakerBool is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">BuilderClass</span><span class="o">.</span><span class="n">WatchMakeWithMakerBool</span><span class="p">),</span>
        <span class="s">&#39;BuilderClass.make is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">BuilderClass</span><span class="o">.</span><span class="n">make</span><span class="p">),</span>
        <span class="s">&#39;BuilderClass.build is &#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">BuilderClass</span><span class="o">.</span><span class="n">build</span><span class="p">),</span>
        <span class="s">&#39;MyBuilder is &#39;</span><span class="o">+</span><span class="n">SYS</span><span class="o">.</span><span class="n">_str</span><span class="p">(</span>
        <span class="n">MyBuilder</span><span class="p">,</span>
        <span class="o">**</span><span class="p">{</span>
            <span class="s">&#39;RepresentingBaseKeyStrsListBool&#39;</span><span class="p">:</span><span class="bp">False</span><span class="p">,</span>
            <span class="s">&#39;RepresentingAlineaIsBool&#39;</span><span class="p">:</span><span class="bp">False</span><span class="p">,</span>
            <span class="s">&#39;RepresentingKeyStrsList&#39;</span><span class="p">:[</span>
