...
__AttributeKeyStr.startswith(AttestingPrefixStr),
                ...
                #debug
                '''
                print('self.AttestedMethodStrsList is
'+str(self.AttestedMethodStrsList))
                print('')
                '''
...
#Set
AttesterClass.DeriveClassor.AttestingFolderPathStr=SYS.PythonlogyLocalFolderPath
Str+AttesterClass.__module__.replace(
'.','/')+'/Attests/'
