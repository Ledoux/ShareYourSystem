...
class JoinerClass(BaseClass):
	...
	def do_join(	
		...
		'''
		#set
		JoinedAttentionCollectionOrderedSetKeyStr=self.JoiningAttentionStr+self.JoiningCollectionStr+"CollectionOrderedDict"
		...
		#set
		JoinedCatchCollectionOrderedSetKeyStr=self.JoiningCatchStr+self.JoiningCollectionStr+"CollectionOrderedDict"
