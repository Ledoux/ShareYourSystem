...
setup(
		...
		packages=[
					'ShareYourSystem',
			 		...
			 		'ShareYourSystem.Standards.Itemizers.Networker',
			 		...
			 		'ShareYourSystem.Standards.Computers.Matrixer',
			 		'ShareYourSystem.Standards.Recorders.Recorder',
			 		'ShareYourSystem.Standards.Recorders.Tracer',
			 		'ShareYourSystem.Standards.Recorders.Moniter',
			 		...
			 		'ShareYourSystem.Standards.Computers',
			 		'ShareYourSystem.Standards.Recorders',
