...
#define SWIGTYPE_p_std__vectorT__Tp__Alloc_t swig_types[28]
...
#define SWIGTYPE_p_std__vectorT_fpos_t_std__allocatorT_fpos_t_t_t swig_types[31]
...
SWIGINTERNINLINE PyObject*
SWIG_From_std_complex_Sl_double_Sg_  (/*@SWIG:/usr/local/share/swig/3.0.2/typemaps/swigmacros.swg,104,%ifcplusplus@*/
...
SWIGINTERN PyObject *_wrap_CToolClass_setDicts(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  CToolClass *arg1 = (CToolClass *) 0 ;
  std::map< std::string,double,std::less< std::string >,std::allocator< std::pair< std::string const,double > > > arg2 ;
  std::map< std::string,int,std::less< std::string >,std::allocator< std::pair< std::string const,int > > > arg3 ;
  std::map< std::string,std::string,std::less< std::string >,std::allocator< std::pair< std::string const,std::string > > > arg4 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  PyObject * obj1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOO:CToolClass_setDicts",&obj0,&obj1,&obj2,&obj3)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_CToolClass, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  arg1 = reinterpret_cast< CToolClass * >(argp1);
  {
    ...
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "CToolClass_setDicts" "', argument " "2"" of type '" "std::map< std::string,double,std::less< std::string >,std::allocator< std::pair< std::string const,double > > >""'"); 
    }
    arg2 = *ptr;
  ...
  }
  {
    ...
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "CToolClass_setDicts" "', argument " "3"" of type '" "std::map< std::string,int,std::less< std::string >,std::allocator< std::pair< std::string const,int > > >""'"); 
    }
    arg3 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  {
    ...
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "CToolClass_setDicts" "', argument " "4"" of type '" "std::map< std::string,std::string,std::less< std::string >,std::allocator< std::pair< std::string const,std::string > > >""'"); 
    }
    arg4 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  (arg1)->setDicts(arg2,arg3,arg4);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
