...
from ShareYourSystem.Brianers import Neurongrouper,Synapser
import operator
#</ImportSpecificModules>
...
class BrianerClass(BaseClass):
	...
	def do_brian(self):	
		...
		self.BrianedSynapsesList=map(
				lambda __NetworkedDeriveSynapser:
				__NetworkedDeriveSynapser.synapse().SynapsedSynapsesVariable,
				self.NetworkedDeriveSynapsersList
			)
