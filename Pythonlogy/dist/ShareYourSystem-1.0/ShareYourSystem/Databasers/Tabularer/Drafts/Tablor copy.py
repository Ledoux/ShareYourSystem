...
class TablerClass(
	...
	def tabular(self,_TabularingStr):
		...
		ModeledOrderedDictKeyStr="Modeled"+DoneTabularingStr+"OrderedDict"
		if hasattr(self,ModeledOrderedDictKeyStr):
			ModeledOrderedDict=getattr(self,ModeledOrderedDictKeyStr)
			...
			if hasattr(self,TabularedOrderedDictKeyStr):
				...
				map(
						lambda __TableStrAndTableGroupedPathStrTuple,__ModeledClass:
						...
						#Map on (__TableStr,__TableGroupedPathStr),__ModeledClass
						map(
							lambda __TableStr:
							(
								__TableStr,
			...
			print('WARNING tabular method : not such ModeledOrderedDictKeyStr ',
				ModeledOrderedDictKeyStr)
			...
			if _FlushingStr=="Output":
				...
				FlushingTuplesList+=zip( 
										map(
												...
												SYS.getModeledIntColumnStrWithKeyStr(
													getattr(
