			...
			self.JoinedRetrieveIndexesListColumnStrsList=map(
					...
					"Join"+''.join(
						[
							...
							if __JoinedCatchDeriveJoiner.DatabasedPointDeriveStorerVariable.NodeKeyStr!="" 
							else 'Top'+__JoinedCatchDeriveJoiner.DatabasedPointDeriveStorerVariable.__class__.NameStr,
			...
			self.JoinedRetrieveIndexesListGetStrsList=map(
					...
					"Joined"+''.join(
						[
							...
							if self.DatabasedPointDeriveStorerVariable.NodeKeyStr!="" 
							else 'Top'+self.DatabasedPointDeriveStorerVariable.__class__.NameStr,
...
<small>
View the Joiner sources on <a href="https://github.com/Ledoux/ShareYourSystem/tree/master/Pythonlogy/ShareYourSystem/Databasers/Joiner" target="_blank">Github</a>
</small>
