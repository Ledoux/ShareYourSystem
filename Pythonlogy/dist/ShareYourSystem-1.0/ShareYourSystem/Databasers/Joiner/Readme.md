...
BaseModuleStr="ShareYourSystem.Databasers.Merger"
...
self.debug(('self.',self,['JoinedCatchCollectionOrderedDict']))
                        ...
                        self.JoinedRetrieveIndexesListColumnStrsList=map(
                                        ...
                                        "Join"+''.join(
                                                [
__JoinedCatchDeriveJoiner.DatabasedPointDeriveStorerVariable.NodeKeyStr
                                                        if
__JoinedCatchDeriveJoiner.DatabasedPointDeriveStorerVariable.NodeKeyStr!=""
                                                        else 'Top'+__JoinedCatch
DeriveJoiner.DatabasedPointDeriveStorerVariable.__class__.NameStr,
__JoinedCatchDeriveJoiner.DatabasedSuffixStr
                                                ]
                                        )+"RetrieveIndexesList",
                                        self.JoinedCatchDeriveJoinersList,
                                )
...
self.debug(('self.',self,['JoinedRetrieveIndexesListColumnStrsList']))
                        ...
                        self.JoinedRetrieveIndexesListGetStrsList=map(
                                        ...
                                        "Joined"+''.join(
                                                [
self.DatabasedPointDeriveStorerVariable.NodeKeyStr
                                                        if
self.DatabasedPointDeriveStorerVariable.NodeKeyStr!=""
                                                        else
'Top'+self.DatabasedPointDeriveStorerVariable.__class__.NameStr,
                                                        self.DatabasedSuffixStr,
                                                        'To',
__JoinedCatchDeriveJoiner.DatabasedPointDeriveStorerVariable.NodeKeyStr
                                                        if
__JoinedCatchDeriveJoiner.DatabasedPointDeriveStorerVariable.NodeKeyStr!=""
...
corresponding JoinedRetrieveIndexesList in the NodePointDeriveNoder
                        self.DatabasedPointDeriveStorerVariable.update(
                                zip(
self.JoinedRetrieveIndexesListGetStrsList,
                                                map(
                                                        lambda
...
/TopModulizer/ImageMultiplier/xx0xxParametersJoinerTable Dataset {2/Inf}
    Data:
        (0) {ModeledInt=0, MultiplyingFirstInt=1, MultiplyingSecondInt=3},
        (1) {ModeledInt=1, MultiplyingFirstInt=1, MultiplyingSecondInt=4}
/TopModulizer/RealMultiplier Group
/TopModulizer/RealMultiplier/xx0xxParametersJoinerTable Dataset {2/Inf}
    Data:
        (0) {ModeledInt=0, MultiplyingFirstInt=1, MultiplyingSecondInt=2},
        (1) {ModeledInt=1, MultiplyingFirstInt=2, MultiplyingSecondInt=2}
/xx0xxParametersJoinerTable Dataset {2/Inf}
    Data:
        ...
        (0)  0], ModeledInt=0, ModulizingPowerFloat=1},
        ...
        (1)  1], ModeledInt=1, ModulizingPowerFloat=1}
