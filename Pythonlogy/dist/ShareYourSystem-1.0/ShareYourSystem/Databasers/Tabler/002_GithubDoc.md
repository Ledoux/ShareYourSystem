	...
	def do_table(self):
		...
		if self.TabledKeyStr!="" and self.TabularedFilePointedVariable!=None:
			...
			if self.TabledKeyStr not in self.TabularedKeyStrsList:
				...
				#Append in the self.ModeledDict['TabularedKeyStrsList']
...
<small>
View the Tabler sources on <a href="https://github.com/Ledoux/ShareYourSystem/tree/master/Pythonlogy/ShareYourSystem/Databasers/Tabler" target="_blank">Github</a>
</small>
